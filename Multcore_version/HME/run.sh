...
numactl --physcpubind=16 --membind=0 ocperf.py stat -e offcore_response.all_rfo.llc_miss.remote_dram,offcore_response.all_reads.llc_miss.remote_dram -I 100 -a --cpu=0,2,4,6,8,10,12,14 --per-core > /dev/shm/ReadWrite.log 2>&1 &
